...
- (void)findDominantWavelengthOfPrimaryColor:(LEDColor *)point {
    if ([point excludeFromSelection]) [self.dwPrimaryArray addObject:[NSNumber numberWithInteger:-1]];
        ...
        NSNumber *wavelength;
        if ([point.x floatValue] != [self.whiteColor.x floatValue]) {
            float slope = (([point.y floatValue] - [self.whiteColor.y floatValue])/([point.x floatValue] - [self.whiteColor.x floatValue]));
            ...
            else if ([point.y floatValue] > [self.whiteColor.y floatValue]) wavelength = self.verticalWavelength;
...
-  (id)initWithCCT:(NSString *)cct andLSGCLight:(LSGCLight *)lsgcLight{
    ...
    if ([cct isEqualToString:@"2700"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.459] andy:[NSNumber numberWithFloat:.411] andY:[NSNumber numberWithFloat:100] andName:@"2700K"];
        ...
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.452] andy:[NSNumber numberWithFloat:.409] andY:[NSNumber numberWithFloat:100] andName:@"2800K"];
    }
    else if ([cct isEqualToString:@"2900"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.444] andy:[NSNumber numberWithFloat:.406] andY:[NSNumber numberWithFloat:100] andName:@"2900K"];
    }
    else if ([cct isEqualToString:@"3000"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.437] andy:[NSNumber numberWithFloat:.404] andY:[NSNumber numberWithFloat:100] andName:@"3000K"];
        ...
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.430] andy:[NSNumber numberWithFloat:.402] andY:[NSNumber numberWithFloat:100] andName:@"3100K"];
    }
    else if ([cct isEqualToString:@"3200"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.423] andy:[NSNumber numberWithFloat:.399] andY:[NSNumber numberWithFloat:100] andName:@"3200K"];
    }
    else if ([cct isEqualToString:@"3300"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.417] andy:[NSNumber numberWithFloat:.396] andY:[NSNumber numberWithFloat:100] andName:@"3300K"];
    }
    else if ([cct isEqualToString:@"3400"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.411] andy:[NSNumber numberWithFloat:.394] andY:[NSNumber numberWithFloat:100] andName:@"3400K"];
    }
    else if ([cct isEqualToString:@"3500"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.405] andy:[NSNumber numberWithFloat:.390] andY:[NSNumber numberWithFloat:100] andName:@"3500K"];
        ...
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.400] andy:[NSNumber numberWithFloat:.388] andY:[NSNumber numberWithFloat:100] andName:@"3600K"];
    }
    else if ([cct isEqualToString:@"3700"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.395] andy:[NSNumber numberWithFloat:.385] andY:[NSNumber numberWithFloat:100] andName:@"3700K"];
    }
    else if ([cct isEqualToString:@"3800"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.390] andy:[NSNumber numberWithFloat:.382] andY:[NSNumber numberWithFloat:100] andName:@"3800K"];
    }
    else if ([cct isEqualToString:@"3900"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.385] andy:[NSNumber numberWithFloat:.380] andY:[NSNumber numberWithFloat:100] andName:@"3900K"];
    }
    else if ([cct isEqualToString:@"4000"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.380] andy:[NSNumber numberWithFloat:.377] andY:[NSNumber numberWithFloat:100] andName:@"4000K"];
        ...
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.376] andy:[NSNumber numberWithFloat:.374] andY:[NSNumber numberWithFloat:100] andName:@"4100K"];
    }
    else if ([cct isEqualToString:@"4200"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.372] andy:[NSNumber numberWithFloat:.371] andY:[NSNumber numberWithFloat:100] andName:@"4200K"];
    }
    else if ([cct isEqualToString:@"4300"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.368] andy:[NSNumber numberWithFloat:.369] andY:[NSNumber numberWithFloat:100] andName:@"4300K"];
    }
    else if ([cct isEqualToString:@"4400"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.364] andy:[NSNumber numberWithFloat:.366] andY:[NSNumber numberWithFloat:100] andName:@"4400K"];
    }
    else if ([cct isEqualToString:@"4500"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.361] andy:[NSNumber numberWithFloat:.364] andY:[NSNumber numberWithFloat:100] andName:@"4500K"];
        ...
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.357] andy:[NSNumber numberWithFloat:.361] andY:[NSNumber numberWithFloat:100] andName:@"4600K"];
    }
    else if ([cct isEqualToString:@"4700"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.354] andy:[NSNumber numberWithFloat:.359] andY:[NSNumber numberWithFloat:100] andName:@"4700K"];
    }
    else if ([cct isEqualToString:@"4800"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.351] andy:[NSNumber numberWithFloat:.356] andY:[NSNumber numberWithFloat:100] andName:@"4800K"];
    }
    else if ([cct isEqualToString:@"4900"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.348] andy:[NSNumber numberWithFloat:.354] andY:[NSNumber numberWithFloat:100] andName:@"4900K"];
    }
    else if ([cct isEqualToString:@"5000"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.345] andy:[NSNumber numberWithFloat:.352] andY:[NSNumber numberWithFloat:100] andName:@"5000K"];
        ...
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.342] andy:[NSNumber numberWithFloat:.349] andY:[NSNumber numberWithFloat:100] andName:@"5100K"];
    }
    else if ([cct isEqualToString:@"5200"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.340] andy:[NSNumber numberWithFloat:.347] andY:[NSNumber numberWithFloat:100] andName:@"5200K"];
    }
    else if ([cct isEqualToString:@"5300"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.337] andy:[NSNumber numberWithFloat:.345] andY:[NSNumber numberWithFloat:100] andName:@"5300K"];
    }
    else if ([cct isEqualToString:@"5400"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.335] andy:[NSNumber numberWithFloat:.343] andY:[NSNumber numberWithFloat:100] andName:@"5400K"];
    }
    else if ([cct isEqualToString:@"5500"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.332] andy:[NSNumber numberWithFloat:.341] andY:[NSNumber numberWithFloat:100] andName:@"5500K"];
    }
    else if ([cct isEqualToString:@"5600"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.330] andy:[NSNumber numberWithFloat:.339] andY:[NSNumber numberWithFloat:100] andName:@"5600K"];
    }
    else if ([cct isEqualToString:@"5700"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.328] andy:[NSNumber numberWithFloat:.337] andY:[NSNumber numberWithFloat:100] andName:@"5700K"];
        ...
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.326] andy:[NSNumber numberWithFloat:.335] andY:[NSNumber numberWithFloat:100] andName:@"5800K"];
    }
    else if ([cct isEqualToString:@"5900"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.324] andy:[NSNumber numberWithFloat:.334] andY:[NSNumber numberWithFloat:100] andName:@"5900K"];
    }
    else if ([cct isEqualToString:@"6000"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.322] andy:[NSNumber numberWithFloat:.332] andY:[NSNumber numberWithFloat:100] andName:@"6000K"];
    }
    else if ([cct isEqualToString:@"6100"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.320] andy:[NSNumber numberWithFloat:.330] andY:[NSNumber numberWithFloat:100] andName:@"6100K"];
    }
    else if ([cct isEqualToString:@"6200"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.318] andy:[NSNumber numberWithFloat:.328] andY:[NSNumber numberWithFloat:100] andName:@"6200K"];
    }
    else if ([cct isEqualToString:@"6300"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.317] andy:[NSNumber numberWithFloat:.327] andY:[NSNumber numberWithFloat:100] andName:@"6300K"];
    }
    else if ([cct isEqualToString:@"6400"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.315] andy:[NSNumber numberWithFloat:.325] andY:[NSNumber numberWithFloat:100] andName:@"6400K"];
    }
    else if ([cct isEqualToString:@"6500"]) {
        self.whiteColor = [[LEDColor alloc] initWithx:[NSNumber numberWithFloat:.313] andy:[NSNumber numberWithFloat:.323] andY:[NSNumber numberWithFloat:100] andName:@"6500K"];
...
/*
 DominantWavelength *dw = [[DominantWavelength alloc] init];
 if ([selectedColor.x floatValue] != [self.whiteColor.x floatValue]) {
 dw.slope = [NSNumber numberWithFloat:((selectedColor.y.floatValue - self.whiteColor.y.floatValue)/(selectedColor.x.floatValue - self.whiteColor.x.floatValue))];
 ...
 else if (selectedColor.y.floatValue > self.whiteColor.y.floatValue) dw.dominantWavelength = self.verticalWavelength;
...
- (void)findDominantWavelengthAndIntersectingColorOfColorPoint:(LEDColor *)selectedColor {
    ...
    else xSecondary = self.whiteColor.x.floatValue;
